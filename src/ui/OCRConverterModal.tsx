...
// pdfjs worker setup - Using ESM.sh for reliable module resolution
pdfjs.GlobalWorkerOptions.workerSrc = 'https://esm.sh/pdfjs-dist@5.5.207/build/pdf.worker.min.mjs';
