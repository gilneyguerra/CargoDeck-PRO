   ...
   return (
     <div className="relative flex items-center gap-1">
       ...
       <button 
         ...
         className="text-neutral-400 hover:text-indigo-400 transition-colors p-1 rounded hover:bg-blue-900/20"
         title="Editar local"
       >
       ...
       <button 
         ...
         className="text-neutral-400 hover:text-red-400 transition-colors p-1 rounded hover:bg-red-900/20"
         title="Excluir local"
       >
...
export function DeckArea() {
    ...
    return (
        <div className="flex flex-col h-full w-full">
            ...
            <div className="flex items-center justify-between mb-4 relative">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative flex flex-row items-center gap-2">
                      ...
                      className="flex-1 min-w-0 px-4 py-2 pl-10 text-sm bg-neutral-800/50 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-neutral-100"
                    />
            ...
            <div className="flex-1 bg-[#101014] border border-neutral-800/50 rounded-xl p-4 sm:p-6 relative flex flex-col items-center overflow-auto shadow-inner">
                <div className="w-full max-w-[800px] sm:max-w-full md:max-w-[1000px] lg:max-w-[1200px] min-h-[600px] sm:min-h-[800px] h-full bg-[#18181f] border border-neutral-800 rounded-t-[50px] sm:rounded-t-[100px] rounded-b-xl relative flex flex-col p-4 sm:p-6 shadow-2xl">
